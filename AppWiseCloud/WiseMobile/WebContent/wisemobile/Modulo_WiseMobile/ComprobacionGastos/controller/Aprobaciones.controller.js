		...
		onPressAprobarAntc: function(oEvt){
		    ...
		    if(length==0){
        		...
        		var oNameModel = oTable.getBindingInfo("items").model; // "mTables"
	   			...
	   			oCnt_FHelps.f_showMessage("INFORMATION", oCnt_FHelps.f_readTranslate("AprobacionAnticipo.Exito.text"), undefined, oCnt_FHelps.f_readTranslate("Exito.title") );
        	}
			
		},
		
		onPressRechazarAntc: function(oEvt){
			oCnt_FHelps.f_showMessage("INFORMATION", oCnt_FHelps.f_readTranslate("RechazarAnticipo.Exito.text"), undefined, oCnt_FHelps.f_readTranslate("Exito.title") );
		},
		    ...
		    if(length==0){
				...
				var oBusyDialog_c = new sap.m.BusyDialog({
					...
					close : function(oEvt) {
						...
						oCnt_FHelps.f_showMessage("INFORMATION", oCnt_FHelps.f_readTranslate("Aprobacion.Exito.text"), undefined, oCnt_FHelps.f_readTranslate("Exito.title") );
					}
				});
