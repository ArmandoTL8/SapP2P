						...
						new sap.m.List({
							...
							items : [
								new sap.m.StandardListItem({
									...
									type: "Navigation",
									visible:sap.ui.getCore().getModel("mConfiguracion").getProperty("/1/PERMISOSV/0").InvOcCfdi,
								}).addCustomData( new sap.ui.core.CustomData({key:"1"}) ),
								new sap.m.StandardListItem({
									title : " - {i18n>GondiQA.Main.Popover.1.List.2}",
									type: "Navigation",
									visible:sap.ui.getCore().getModel("mConfiguracion").getProperty("/1/PERMISOSV/0").InvOcNormal,
						...
						new sap.m.List({
							...
							items : [
								new sap.m.StandardListItem({
									...
									type: "Navigation",
									visible:sap.ui.getCore().getModel("mConfiguracion").getProperty("/1/PERMISOSV/0").InvWoOcCfdi,
								}).addCustomData( new sap.ui.core.CustomData({key:"3"}) ),
								new sap.m.StandardListItem({
									title : " - {i18n>GondiQA.Main.Popover.2.List.2}",
									type: "Navigation",
									visible:sap.ui.getCore().getModel("mConfiguracion").getProperty("/1/PERMISOSV/0").InvWoOcNormal,
